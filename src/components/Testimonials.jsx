    ...
    const testimonials = [
        {
            ...
            name: 'Nicholas O.',
            title: 'Client',
            content: 'Recovery Delivered is great! I cannot believe how fast and easy the process is. '
                + 'The staff and providers are very quick to respond to your messages. I made my appointment'
                + ' same day and had everything I needed. I was so surprised. Thank you Recovery Delivered!',
            rating: 3.5,
            image: clientImg1
        },
        {
            ...
            title: 'Client',
            content:
                'My daughter started her online opioid treatment program not too long ago and the process'
                + ' was so fast and simple. Very affordable as well. We are in Florida and were able to do '
        ...
        },
        {
            ...
            content:
                ...
                + 'I went to an actual Suboxone doctor in my area for three years and it took so much time, '
                + 'he caused me so much anxiety and made my entire treatment hard.',
            rating: 3.5,
            image: clientImg3
        }
    ];
        ...
        <div>
            <div className="flex justify-between items-center mb-10">
                ...
                <div className="flex gap-2">
                    <button type="button" onClick={() => {}} className="p-2 rounded-full border border-gray-200 hover:bg-gray-50 transition-colors">
                        <LeftArrow />
                    </button>
                    <button type="button" onClick={() => {}} className="p-2 rounded-full bg-teal-500 text-white hover:bg-teal-600 transition-colors">
                        <RightArrow />
                    </button>
                </div>
            </div>
